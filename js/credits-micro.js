        ...
        <div class="result__tr flex">
            ...
            <div class="result__tbody-box flex">
                <div class="result__td">
                    ...
                    <div class="result__block">
                        <p><span>${bankInfo.amount.min} ₽ - ${bankInfo.amount.max} ₽</span> На срок до ${bankInfo.period.max} дней</p>
                    </div>
                </div>
                <div class="result__td">
                    <div class="result__caption">Условия</div>
                    <div class="result__block">
                        ${bankInfo.docs && `<p>Без документов</p>`}
                        <p>Возраст от ${bankInfo.minAge} лет</p>
                    </div>
                </div>
                <div class="result__td">
                    <div class="result__caption">способ получения</div>
                    <div class="result__block">
                        <ul>
                            ${bankInfo.money_type.reduce((r, type) => {
                                switch(type) {
                                    case 1:
                                        return r + `<li>На банковскую карту</li>`;
                                    case 2:
                                        return r + `<li>На банковский счёт</li>`;
                                    case 3:
                                        return r + `<li>Наличными</li>`;
                                    case 4:
                                        return r + `<li>На электронный кошелёк</li>`;
                                }
                            }, '')}
                        </ul>
                    </div>
